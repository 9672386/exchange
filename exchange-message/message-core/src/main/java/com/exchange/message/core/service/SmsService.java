...
public interface SmsService {
     ...
     * @return 发送响应
     */
    MessageSendResponse sendAliyunSms(String phoneNumber, String templateCode, Map<String, Object> templateParams);
     ...
     * @return 发送响应
     */
    MessageSendResponse sendTencentSms(String phoneNumber, String templateId, Map<String, Object> templateParams);
