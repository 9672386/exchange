...
public class MessageTemplate {
    ...
    @Schema(description = "语言代码", required = true)
    @NotBlank(message = "语言代码不能为空")
    private String languageCode;
    
    @Schema(description = "多语言模板内容")
    private Map<String, String> multiLanguageContent;
    
    @Schema(description = "多语言模板标题")
    private Map<String, String> multiLanguageSubject;
